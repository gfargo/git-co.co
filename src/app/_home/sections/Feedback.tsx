...
export const FeedbackSection = () => {
  return (
    <Section id="feedback" className="bg-[#5E8F78] text-white">
        ...
        <div className="mx-auto grid gap-8 sm:max-w-4xl sm:grid-cols-1 md:gap-12 lg:max-w-5xl lg:grid-cols-2 py-8">
          <div>
            <blockquote className="text-white text-center">
              &quot;This is the best Git assistant I&apos;ve ever used. It has
              made my workflow so much smoother and faster.&quot;
            </blockquote>
          ...
          <div>
            <blockquote className="text-white text-center">
              &quot;I love how it automates so much of the Git process.
              It&apos;s a game changer.&quot;
            </blockquote>
            <p className="text-sm font-medium text-white text-center">
