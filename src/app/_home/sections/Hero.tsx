...
export const HeroSection = () => {
  return (
    <Section id="hero" className=" bg-[#719f8b] text-white lg:py-32">
        ...
        <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 lg:grid-cols-2">
          <div className="flex flex-col w-full gap-4 justify-start items-start">
            ...
            <div className="flex flex-row items-center">
              <h1 className="lg:leading-tighter text-2xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-[3.4rem] 2xl:text-[3.75rem] drop-shadow-xl min-h-[180px]">
